...
if page == "Info":
    ...
    team_info = {
        "ΓΕΤΕΡΙΔΟΥ ΑΝΑΣΤΑΣΙΑ": "Ανάπτυξη του συστήματος φόρτωσης δεδομένων και οπτικοποιήσεων.",
        "ΠΙΣΠΑΣ ΓΕΩΡΓΙΟΣ": "Σχεδίαση και υλοποίηση των αλγορίθμων επιλογής χαρακτηριστικών.",
        "ΒΑΒΛΙΑΡΑ ΚΥΡΙΑΚΗ": "Ενσωμάτωση αλγορίθμων κατηγοριοποίησης και παρουσίαση αποτελεσμάτων.",
    }

    for member, task in team_info.items():
        st.write(f"- **{member}**: {task}")

    st.subheader("Ευχαριστίες")
    st.write(""" Ευχαριστούμε όλους όσους συνέβαλαν στην ανάπτυξη αυτής της εφαρμογής. """)
